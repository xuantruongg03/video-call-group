  ...
  const handleJoinRoomWithPassword = async (password: string) => {
    verifyRoomMutation({ roomId: roomId, password: password }).then((res) => {
      if (res.data.valid) {
        dispatch({
          type: "JOIN_ROOM",
          payload: { username: userName, password: password, isLocked: true },
        });
  ...
  const handleJoinRoom = async () => {
    ...
    if (userName.trim() === "") {
      do {
        const randomName =
          nameDefault[Math.floor(Math.random() * nameDefault.length)];
        isUsernameValid = await checkUsername(randomName).then(
      ...
      isUsernameValid = await checkUsername(userName).then(
        (res) => res.data.success
      );
      if (!isUsernameValid) {
        toast.error(
          "Tên người dùng đã tồn tại trong phòng này! Vui lòng chọn tên khác."
        );
        return;
      }
    }

    checkRoomStatusMutation({ roomId: roomId })
      .then((res) => {
        if (res.data.locked) {
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-600 max-w-2xl text-lg md:text-xl mb-8">
              Nền tảng họp trực tuyến chất lượng cao với đầy đủ tính năng, dễ sử
              dụng và hoàn toàn miễn phí. Không cần tải xuống, hoạt động trực
              tiếp trên trình duyệt của bạn.
            </p>
              ...
              <Card className="w-full max-w-md mx-auto bg-white/80 backdrop-blur-sm shadow-xl border-0 overflow-hidden rounded-2xl">
                <CardContent className="pt-6">
                  <div className="flex flex-col space-y-4">
                    ...
                    >
                      {isPending || isRoomStatusPending || isVerifyRoomPending
                        ? "Đang tham gia..."
                        : "Tham gia phòng"}
      ...
      <section className="container mx-auto py-24 px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Nền tảng họp trực tuyến của chúng tôi cung cấp đầy đủ tính năng,
            giúp bạn tổ chức các cuộc họp hiệu quả.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Card className="border-0 shadow-md hover:shadow-lg transition-shadow bg-white/70 backdrop-blur p-2 overflow-hidden">
            <CardContent className="pt-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Hội họp với hình ảnh và âm thanh chất lượng cao, đảm bảo trải
                nghiệm giao tiếp tốt nhất.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-md hover:shadow-lg transition-shadow bg-white/70 backdrop-blur p-2 overflow-hidden">
            <CardContent className="pt-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Trao đổi thông tin nhanh chóng qua tính năng chat trong khi vẫn
                tiếp tục cuộc họp video.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-md hover:shadow-lg transition-shadow bg-white/70 backdrop-blur p-2 overflow-hidden">
            <CardContent className="pt-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Mã hóa đầu cuối đảm bảo các cuộc trò chuyện của bạn luôn được
                bảo mật và riêng tư.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-blue-100 max-w-2xl mx-auto text-lg">
              Chỉ với vài bước đơn giản, bạn có thể tạo và tham gia các cuộc họp
              trực tuyến ngay lập tức.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl">
              <div className="h-16 w-16 rounded-full bg-white/20 flex items-center justify-center text-white text-xl font-bold mx-auto mb-4">
                1
              </div>
              ...
              <p className="text-blue-100">
                Nhấn vào nút "Tạo phòng mới" để khởi tạo phòng họp trực tuyến
                với mã phòng duy nhất.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl">
              <div className="h-16 w-16 rounded-full bg-white/20 flex items-center justify-center text-white text-xl font-bold mx-auto mb-4">
              ...
              <p className="text-blue-100">
                Gửi mã phòng họp cho những người bạn muốn mời tham gia qua
                email, tin nhắn hoặc mạng xã hội.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl">
              <div className="h-16 w-16 rounded-full bg-white/20 flex items-center justify-center text-white text-xl font-bold mx-auto mb-4">
              ...
              <p className="text-blue-100">
                Người được mời nhập mã phòng, cho phép camera và microphone, và
        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 max-w-2xl mx-auto mb-8 text-lg">
              Tham gia cùng hàng nghìn người dùng đang sử dụng nền tảng của
              chúng tôi cho nhu cầu họp trực tuyến.
            </p>
            <Button
              onClick={handleCreateRoom}
              size="lg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Nền tảng họp trực tuyến chất lượng cao, dễ sử dụng và hoàn toàn
                miễn phí.
              </p>
          ...
          <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-gray-500 text-sm">
                © 2025 VideoMeet. Tất cả các quyền được bảo lưu.
              </p>
            </div>
